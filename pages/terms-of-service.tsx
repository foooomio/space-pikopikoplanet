    ...
    <Layout>
      ...
      <Segment>
        <Container text>
          ...
          <p>
            この利用規約（以下、「本規約」といいます。）は、☆ピコピコプラネット☆
            SPACE
            運営者（以下、「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
          ...
          <ol>
            <li>
              ユーザーは、自ら著作権等の必要な知的財産権を有するか、または必要な権利者の許諾を得た文章等の情報に関してのみ、本サービスを利用し、投稿することができるものとします。
            </li>
            <li>
              ユーザーが本サービスを利用して投稿した文章等の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。ユーザーは、オープンデータ普及のため、本サービスを利用して投稿した文章等について、クリエイティブ・コモンズ・ライセンスの
            ...
            <li>
              運営者およびユーザーは、本サービスを利用して投稿された文章等について、特段の定めなき限り、前項本文の定めるライセンスのもとで利用できるものとします。
            </li>
          </ol>
